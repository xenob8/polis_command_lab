...
public class DialogueTest {
    ...
    public void messageSendCheck() {
        ...
        loginPage.loginAs(LOGIN_SENDER, PASSWORD_SENDER).clickMessageButton().sendMessageToReceiver(MESSAGE);
    }
    ...
    public void messageReceiveCheck() {
        ...
        assertEquals(messagePage.getLastMessageFromSender(), MESSAGE);
    }
